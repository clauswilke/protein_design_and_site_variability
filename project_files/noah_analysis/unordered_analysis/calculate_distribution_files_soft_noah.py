...
for identity in identities:
    ...
    designed_filename = identity + "_" + pdb_id + "_" + chain_id + "_" + "soft" + ".fasta"
    ...
    #search string to use
    file = "results_array_" + pdb_id + "_" + chain_id +"_" + "soft" + ".csv" 
    print file 
    ...
    designed_fpW = open("align_data_array_" + pdb_id + "_" + chain_id + "_" + "soft" + ".dat","w")
