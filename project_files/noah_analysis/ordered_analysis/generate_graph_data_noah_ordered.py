...
for pdb_id in PDBS:
	...
	designed_proteins_00 = "align_data_array_ordered_" + pdb_id + "_" + chain_id + "_" + str(0.0)  + ".dat"
	designed_proteins_03 = "align_data_array_ordered_" + pdb_id + "_" + chain_id + "_" + str(0.3)  + ".dat"
	designed_proteins_06 = "align_data_array_ordered_" + pdb_id + "_" + chain_id + "_" + str(0.6)  + ".dat"
	designed_proteins_09 = "align_data_array_ordered_" + pdb_id + "_" + chain_id + "_" + str(0.9)  + ".dat"
	designed_proteins_12 = "align_data_array_ordered_" + pdb_id + "_" + chain_id + "_" + str(1.2)  + ".dat"
	designed_proteins_18 = "align_data_array_ordered_" + pdb_id + "_" + chain_id + "_" + str(1.8)  + ".dat"
	designed_proteins_24 = "align_data_array_ordered_" + pdb_id + "_" + chain_id + "_" + str(2.4)  + ".dat"
	designed_proteins_soft = "align_data_array_ordered_" + pdb_id + "_" + chain_id + "_" + "soft"  + ".dat"
	...
	raw_file_00 = "raw_mle_lines_ordered_0.0_noah.csv"
	raw_file_03 = "raw_mle_lines_ordered_0.3_noah.csv"
	raw_file_06 = "raw_mle_lines_ordered_0.6_noah.csv"
	raw_file_09 = "raw_mle_lines_ordered_0.9_noah.csv"
	raw_file_12 = "raw_mle_lines_ordered_1.2_noah.csv"
	raw_file_18 = "raw_mle_lines_ordered_1.8_noah.csv"       
	raw_file_24 = "raw_mle_lines_ordered_2.4_noah.csv"   
	raw_file_soft = "raw_mle_lines_ordered_soft_noah.csv"     
	raw_file_natural = "raw_mle_lines_ordered_natural_noah.csv"

	#Gets the slopes/intercept data
	intercept_dict_00, slope_dict_00 = af.get_slope_intercept(raw_file_00)
	intercept_dict_03, slope_dict_03 = af.get_slope_intercept(raw_file_03)
	intercept_dict_06, slope_dict_06 = af.get_slope_intercept(raw_file_06)
	intercept_dict_09, slope_dict_09 = af.get_slope_intercept(raw_file_09)
	intercept_dict_12, slope_dict_12 = af.get_slope_intercept(raw_file_12)
	intercept_dict_18, slope_dict_18 = af.get_slope_intercept(raw_file_18)
	intercept_dict_24, slope_dict_24 = af.get_slope_intercept(raw_file_24)
	intercept_dict_soft, slope_dict_soft = af.get_slope_intercept(raw_file_soft)
	intercept_dict_natural, slope_dict_natural = af.get_slope_intercept_natural(raw_file_natural)

	#print "Intercept dict: Temp Soft"
	#print intercept_dict_soft
	
	#print "Slope dict: Temp Soft"
	#print slope_dict_soft
	
	#print "Intercept dict: Temp 00"
	#print intercept_dict_00
	
	#print "Slope dict: Temp Soft"
	#print slope_dict_00

	#Calculates all of the data for comparison (ex. entropy)
	natural_distribution = af.get_AA_distribution_KL(natural_proteins)     
	...
	designed_distribution_00 = af.get_AA_distribution_KL(designed_proteins_00)        
	...
	designed_distribution_03 = af.get_AA_distribution_KL(designed_proteins_03)
	...
	designed_distribution_06 = af.get_AA_distribution_KL(designed_proteins_06)
	...
	designed_distribution_09 = af.get_AA_distribution_KL(designed_proteins_09)
	...
	designed_distribution_12 = af.get_AA_distribution_KL(designed_proteins_12)
	...
	designed_distribution_18 = af.get_AA_distribution_KL(designed_proteins_18)
	...
	designed_distribution_24 = af.get_AA_distribution_KL(designed_proteins_24)
	...
	designed_distribution_soft = af.get_AA_distribution_KL(designed_proteins_soft)
	...
	#print designed_mean_KL_values_soft
	split_1_distribution = af.get_AA_distribution_KL(split_natural_1)
	split_2_distribution = af.get_AA_distribution_KL(split_natural_2)
...
#open file name
natural_mean_graphing_filename = "graph_mean_data_ordered_natural_noah.csv"
...
#open file name
natural_mean_graphing_filename = "graph_mean_buried_data_ordered_natural_noah.csv"
natural_mean_file = open(natural_mean_graphing_filename, "w")
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_0.0_noah.csv"
...
while(length_counter<designed_name_length):
    ...
    designed_filestring = pdb_names[length_counter] +"\t" + chain_names[length_counter] + "\t" + str(designed_mean_RSA) + "\t" + str(designed_mean_entropy) + "\t" + str(designed_cor_entropy_RSA) + "\t" + str(designed_mean_KL) + "\t" + str(intercept_dict_00[pdb_counter]) + "\t" + str(slope_dict_00[pdb_counter]) 
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_buried_data_ordered_0.0_noah.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_0.3_noah.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
...
while(length_counter<designed_name_length):
    ...
    designed_filestring = pdb_names[length_counter] +"\t" + chain_names[length_counter] + "\t" + str(designed_mean_RSA) + "\t" + str(designed_mean_entropy) + "\t" + str(designed_cor_entropy_RSA) + "\t" + str(designed_mean_KL) + "\t" + str(intercept_dict_03[pdb_counter]) + "\t" + str(slope_dict_03[pdb_counter]) 
    designed_mean_file.write(designed_filestring)
    length_counter = length_counter + 1
designed_mean_file.close()
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_0.6_noah.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_RSA\tmean_entropy\tcor_entropy_RSA\tmean_KL\tintercept\tslope\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
    ...
    designed_filestring = pdb_names[length_counter] +"\t" + chain_names[length_counter] + "\t" + str(designed_mean_RSA) + "\t" + str(designed_mean_entropy) + "\t" + str(designed_cor_entropy_RSA) +"\t" + str(designed_mean_KL) + "\t" + str(intercept_dict_06[pdb_counter]) + "\t" + str(slope_dict_06[pdb_counter]) 
    designed_mean_file.write(designed_filestring)
    length_counter = length_counter + 1
designed_mean_file.close()
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_buried_data_ordered_0.6_noah.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_entropy\tmean_KL\tintercept\tslope\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
...
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_0.9_noah.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_RSA\tmean_entropy\tcor_entropy_RSA\tmean_KL\tintercept\tslope\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
    ...
    designed_filestring = pdb_names[length_counter] +"\t" + chain_names[length_counter] + "\t" + str(designed_mean_RSA) + "\t" + str(designed_mean_entropy) + "\t" + str(designed_cor_entropy_RSA) +  "\t" + str(designed_mean_KL)+  "\t" + str(intercept_dict_09[pdb_counter]) + "\t" + str(slope_dict_09[pdb_counter]) 
    designed_mean_file.write(designed_filestring)
    length_counter = length_counter + 1
designed_mean_file.close()
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_buried_data_ordered_0.9_noah.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_entropy\tmean_KL\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
...
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_1.2_noah.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_RSA\tmean_entropy\tcor_entropy_RSA\tmean_KL\tintercept\tslope\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
    ...
    designed_filestring = pdb_names[length_counter] +"\t" + chain_names[length_counter] + "\t" + str(designed_mean_RSA) + "\t" + str(designed_mean_entropy) + "\t" + str(designed_cor_entropy_RSA) + "\t" + str(designed_mean_KL) + "\t" + str(intercept_dict_12[pdb_counter]) + "\t" + str(slope_dict_12[pdb_counter])
    designed_mean_file.write(designed_filestring)
    length_counter = length_counter + 1
designed_mean_file.close()
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_buried_data_ordered_1.2_noah.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_entropy\tmean_KL\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_1.8_noah.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_RSA\tmean_entropy\tcor_entropy_RSA\tmean_KL\tintercept\tslope\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
    ...
    designed_filestring = pdb_names[length_counter] +"\t" + chain_names[length_counter] + "\t" + str(designed_mean_RSA) + "\t" + str(designed_mean_entropy) + "\t" + str(designed_cor_entropy_RSA) + "\t" + str(designed_mean_KL) + "\t" + str(intercept_dict_18[pdb_counter]) + "\t" + str(slope_dict_18[pdb_counter]) 
    designed_mean_file.write(designed_filestring)
    length_counter = length_counter + 1
designed_mean_file.close()
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_2.4_noah.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_RSA\tmean_entropy\tcor_entropy_RSA\tmean_KL\tintercept\tslope\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
    ...
    designed_filestring = pdb_names[length_counter] +"\t" + chain_names[length_counter] + "\t" + str(designed_mean_RSA) + "\t" + str(designed_mean_entropy) + "\t" + str(designed_cor_entropy_RSA) + "\t" + str(designed_mean_KL) + "\t" + str(intercept_dict_24[pdb_counter]) + "\t" + str(slope_dict_24[pdb_counter]) 
    designed_mean_file.write(designed_filestring)
    length_counter = length_counter + 1
designed_mean_file.close()
...
#print "Median of KL_array_soft: " + str(median(designed_mean_KL_values_array_soft))
#print designed_mean_KL_values_array_soft
#print "Median of Buried KL_array_soft: " + str(median(buried_mean_KL_values_array_soft))
#print buried_mean_KL_values_array_soft

#print "Median of Intermediate KL_array_soft: " + str(median(intermediate_mean_KL_values_array_soft))
#print intermediate_mean_KL_values_array_soft

#print "Median of Surface KL_array_soft: " + str(median(surface_mean_KL_values_array_soft))
#print surface_mean_KL_values_array_soft

#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_soft_noah.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_RSA\tmean_entropy\tcor_entropy_RSA\tmean_KL\tintercept\tslope\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
    ...
    designed_filestring = pdb_names[length_counter] +"\t" + chain_names[length_counter] + "\t" + str(designed_mean_RSA) + "\t" + str(designed_mean_entropy) + "\t" + str(designed_cor_entropy_RSA) + "\t" + str(designed_mean_KL) + "\t" + str(intercept_dict_soft[pdb_counter]) + "\t" + str(slope_dict_soft[pdb_counter]) 
    designed_mean_file.write(designed_filestring)
    length_counter = length_counter + 1
designed_mean_file.close()

mean_KL_temp_file = open("graph_mean_KL_all_temp_data_ordered_noah.csv", "w")
...
mean_KL_temp_file = open("graph_mean_KL_buried_temp_data_ordered_noah.csv", "w")
mean_KL_temp_file.write("PDB\tmean_KL_temp_0.0\tmean_KL_soft\tmean_KL_soft\tmean_KL_temp_0.3\tmean_KL_temp_0.6\tmean_KL_temp_0.9\tmean_KL_temp_1.2\tmean_KL_temp_1.8\tmean_KL_temp_2.4\tmean_KL_split_natural\n")
length_counter = 0
while(length_counter<designed_name_length):
    string = pdb_names[length_counter] + "\t" + str(buried_mean_KL_values_soft[length_counter]) + "\t" + str(buried_mean_KL_values_00[length_counter]) + "\t" + str(buried_mean_KL_values_03[length_counter]) + "\t" +  str(buried_mean_KL_values_06[length_counter]) + "\t" + str(buried_mean_KL_values_09[length_counter]) + "\t" + str(buried_mean_KL_values_12[length_counter]) + "\t" + str(buried_mean_KL_values_18[length_counter]) + "\t" + str(buried_mean_KL_values_24[length_counter]) + "\t" + str(buried_natural_mean_KL_values[length_counter]) + "\n"
    mean_KL_temp_file.write(string)
    length_counter = length_counter + 1
mean_KL_temp_file.close()  

mean_KL_temp_file = open("graph_mean_KL_intermediate_temp_data_ordered_noah.csv", "w")
mean_KL_temp_file.write("PDB\tmean_KL_temp_0.0\tmean_KL_soft\tmean_KL_temp_0.3\tmean_KL_temp_0.6\tmean_KL_temp_0.9\tmean_KL_temp_1.2\tmean_KL_temp_1.8\tmean_KL_temp_2.4\tmean_KL_split_natural\n")
length_counter = 0
while(length_counter<designed_name_length):
...
mean_KL_temp_file = open("graph_mean_KL_surface_temp_data_ordered_noah.csv", "w")
mean_KL_temp_file.write("PDB\tmean_KL_temp_0.0\tmean_KL_soft\tmean_KL_temp_0.3\tmean_KL_temp_0.6\tmean_KL_temp_0.9\tmean_KL_temp_1.2\tmean_KL_temp_1.8\tmean_KL_temp_2.4\tmean_KL_split_natural\n")
length_counter = 0
while(length_counter<designed_name_length):
...
mean_KL_temp_file = open("graph_mean_entropy_buried_temp_data_ordered_noah.csv", "w")
...
mean_KL_temp_file = open("graph_mean_entropy_intermediate_temp_data_ordered_noah.csv", "w")
...
mean_KL_temp_file = open("graph_mean_entropy_surface_temp_data_ordered_noah.csv", "w")
mean_KL_temp_file.write("PDB\tmean_KL_temp_0.0\tmean_KL_soft\tmean_KL_temp_0.3\tmean_KL_temp_0.6\tmean_KL_temp_0.9\tmean_KL_temp_1.2\tmean_KL_temp_1.8\tmean_KL_temp_2.4\tmean_KL_split_natural\n")
length_counter = 0
while(length_counter<designed_name_length):
