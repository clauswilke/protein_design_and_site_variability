...
mean_KL_temp_file = open("graph_mean_KL_intermediate_temp_data.csv", "r")
mean_KL_temp_data = mean_KL_temp_file.readlines()
mean_KL_temp_file.close()
header = mean_KL_temp_data.pop(0)

mean_KL_temp_ordered_file = open("graph_mean_KL_intermediate_temp_data_ordered.csv", "r")
...
plt.yticks([0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5], ["0.0", "0.5", "1.0", "1.5", "2.0", "2.5", "3.0", "3.5"])
plt.xticks([1, 2, 3, 4, 5, 6, 7, 8], ["FB", "0.03", "0.1", "0.3", "0.6", "0.9", "1.2", "NS"])
save_fig_title = "Mean_KL_vs_Temp_Intermediate_Boxplot" + ".pdf"
savefig(save_fig_title, format = None)
count = count + 1
#show()
...
plt.xticks([1, 2, 3, 4, 5, 6, 7, 8], ["FB", "0.03", "0.1", "0.3", "0.6", "0.9", "1.2", "NS"])
save_fig_title = "Mean_Entropy_vs_Temp_Intermediate_Boxplot" + ".pdf"
savefig(save_fig_title, format = None)
count = count + 1
#show()
