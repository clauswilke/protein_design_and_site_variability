...
mean_KL_temp_file = open("graph_mean_KL_buried_temp_data_noah.csv", "r")
...
save_fig_title = "Mean_KL_vs_Temp_Buried_Boxplot_Noah" + ".pdf"
savefig(save_fig_title, format = None)
count = count + 1
#show()
...
plt.xticks([1, 2, 3, 4, 5, 6, 7, 8, 9], ["FB", "Soft", "0.3", "0.6", "0.9", "1.2", "1.8", "2.4", "NS"])
save_fig_title = "Mean_Entropy_vs_Temp_Buried_Boxplot_Noah" + ".pdf"
savefig(save_fig_title, format = None)
count = count + 1
#plt.show()
