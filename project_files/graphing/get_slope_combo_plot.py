...
protein_file = open("graph_mean_data_ordered_natural.csv", "r")
...
protein_file_name = "graph_mean_data_ordered_0.0.csv"
...
protein_file_name = "graph_mean_data_ordered_0.03.csv"
[designed_mean_RSA_values_003, designed_mean_entropy_values_003, designed_cor_entropy_RSA_values_003, designed_mean_KL_values_003, designed_intercept_values_003, designed_slope_values_003] = analysis_functions.get_mean_ordered_designed_data(protein_file_name)
...
designed_intercept_values_array_003 = array(designed_intercept_values_003)
designed_slope_values_array_003 = array(designed_slope_values_003)

protein_file_name = "graph_mean_data_ordered_0.1.csv"
[designed_mean_RSA_values_01, designed_mean_entropy_values_01, designed_cor_entropy_RSA_values_01, designed_mean_KL_values_01, designed_intercept_values_01, designed_slope_values_01] = analysis_functions.get_mean_ordered_designed_data(protein_file_name)
...
designed_intercept_values_array_01 = array(designed_intercept_values_01)
designed_slope_values_array_01 = array(designed_slope_values_01)

protein_file_name = "graph_mean_data_ordered_0.3.csv"
...
protein_file_name = "graph_mean_data_ordered_0.6.csv"
...
protein_file_name = "graph_mean_data_ordered_0.9.csv"
...
protein_file_name = "graph_mean_data_ordered_1.2.csv"
...
all_temp_slope_values.append(designed_slope_values_01)
...
all_temp_slope_values.append(designed_slope_values_003)
...
ax1.text(0.5, 1.0, "A", fontweight = 'bold', ha = 'center', va = 'center', fontsize = 20)
#grid()
...
p2 = plot(designed_mean_entropy_values_array_003, designed_slope_values_array_003, color = "#F8FC05", linestyle = "None", marker = "o") #Dark Yellow
p3 = plot(designed_mean_entropy_values_array_01, designed_slope_values_array_01, color = "#F5A112", linestyle = "None", marker = "o") #Dark Yellow/Dark Orange
p4 = plot(designed_mean_entropy_values_array_03, designed_slope_values_array_03, color = "#DF7401", linestyle = "None", marker = "o") #Orange
p5 = plot(designed_mean_entropy_values_array_06, designed_slope_values_array_06, color = "#D04900", linestyle = "None", marker = "o") #Dark Orange/ Dark Red
p6 = plot(designed_mean_entropy_values_array_09, designed_slope_values_array_09, color = "#FE2E2E", linestyle = "None", marker = "o") #Light Red
p7 = plot(designed_mean_entropy_values_array_12, designed_slope_values_array_12, color = "#B40404", linestyle = "None", marker = "o") #Dark Red
p8 = plot(natural_mean_entropy_values_array, natural_slope_values_array, color = "#128EF5", linestyle = "None", marker = "o")
...
p2 = plot(designed_intercept_values_array_003, designed_slope_values_array_003, color = "#F8FC05", linestyle = "None", marker = "o") #Dark Yellow
p3 = plot(designed_intercept_values_array_01, designed_slope_values_array_01, color = "#F5A112", linestyle = "None", marker = "o") #Dark Yellow/Dark Orange
p4 = plot(designed_intercept_values_array_03, designed_slope_values_array_03, color = "#DF7401", linestyle = "None", marker = "o") #Orange
p5 = plot(designed_intercept_values_array_06, designed_slope_values_array_06, color = "#D04900", linestyle = "None", marker = "o") #Dark Orange/ Dark Red
p6 = plot(designed_intercept_values_array_09, designed_slope_values_array_09, color = "#FE2E2E", linestyle = "None", marker = "o") #Light Red
p7 = plot(designed_intercept_values_array_12, designed_slope_values_array_12, color = "#B40404", linestyle = "None", marker = "o") #Dark Red
p8 = plot(natural_intercept_values_array, natural_slope_values_array, color = "#128EF5", linestyle = "None", marker = "o")

#This creates the figure legend
l1 = ax2.legend([p1, p2, p3, p4, p5, p6,p7, p8],["Fixed" ,"T = 0.03", "T = 0.1", "T = 0.3", "T = 0.6", "T = 0.9", "T = 1.2", "Natural"], "lower left", frameon = False, numpoints = 1, ncol = 2, prop = {'size': 15}) #Only one dot in the legend, no frame so "False", two columns so ncol = 2, and the font size is 15.

ax2.spines['right'].set_color('none')
#setp(ax2.get_yticklabels(), visible = False)
#ax2.yaxis.set_tick_params(size = 0)
get_plot_format_intercepts("Intercept", "Slope", ax2)
save_figure("Slope_Combination_Plot")
count = count + 1
