...
#Date last updated: August 7, 2013
...
for path, names, filename in os.walk('.',False): #Searchs for all the *.dat files for the #natural protein 
    for file in filename:
        if(re.search(searchStr, file)!=None):
            ...
            designed_proteins_01 = "align_data_array_ordered_" + pdb_id + "_" + chain_id + "_" + str(0.1)  + ".dat"
            ...
            designed_proteins_003 = "align_data_array_ordered_" + pdb_id + "_" + chain_id + "_" + str(0.03)  + ".dat"
            ...
            raw_file_00 = "raw_mle_lines_ordered_0.0.csv"
            raw_file_01 = "raw_mle_lines_ordered_0.1.csv"
            raw_file_03 = "raw_mle_lines_ordered_0.3.csv"
            raw_file_06 = "raw_mle_lines_ordered_0.6.csv"
            raw_file_09 = "raw_mle_lines_ordered_0.9.csv"
            raw_file_12 = "raw_mle_lines_ordered_1.2.csv"
            raw_file_003 = "raw_mle_lines_ordered_0.03.csv"           
            raw_file_natural = "raw_mle_lines_ordered_natural.csv"

            #Gets the slopes/intercept data
            intercept_dict_00, slope_dict_00 = analysis_functions.get_slope_intercept(raw_file_00)
            intercept_dict_01, slope_dict_01 = analysis_functions.get_slope_intercept(raw_file_01)
            intercept_dict_03, slope_dict_03 = analysis_functions.get_slope_intercept(raw_file_03)
            intercept_dict_06, slope_dict_06 = analysis_functions.get_slope_intercept(raw_file_06)
            intercept_dict_09, slope_dict_09 = analysis_functions.get_slope_intercept(raw_file_09)
            intercept_dict_12, slope_dict_12 = analysis_functions.get_slope_intercept(raw_file_12)
            intercept_dict_003, slope_dict_003 = analysis_functions.get_slope_intercept(raw_file_003)
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_0.0.csv"
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_buried_data_ordered_0.0.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_0.03.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_RSA\tmean_entropy\tcor_entropy_RSA\tmean_KL\tintercept\tslope\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
    ...
    designed_filestring = pdb_names[length_counter] +"\t" + chain_names[length_counter] + "\t" + str(designed_mean_RSA) + "\t" + str(designed_mean_entropy) + "\t" + str(designed_cor_entropy_RSA) + "\t" + str(designed_mean_KL) + "\t" + str(intercept_dict_003[pdb_counter]) + "\t" + str(slope_dict_003[pdb_counter]) 
    designed_mean_file.write(designed_filestring)
    length_counter = length_counter + 1
designed_mean_file.close()
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_buried_data_ordered_0.03.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_entropy\tmean_KL\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_0.1.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_RSA\tmean_entropy\tcor_entropy_RSA\tmean_KL\tintercept\tslope\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
    ...
    designed_filestring = pdb_names[length_counter] +"\t" + chain_names[length_counter] + "\t" + str(designed_mean_RSA) + "\t" + str(designed_mean_entropy) + "\t" + str(designed_cor_entropy_RSA) + "\t" + str(designed_mean_KL) + "\t" + str(intercept_dict_01[pdb_counter]) + "\t" + str(slope_dict_01[pdb_counter])
    designed_mean_file.write(designed_filestring)
    length_counter = length_counter + 1
designed_mean_file.close()
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_buried_data_ordered_0.1.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_entropy\tmean_KL\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_0.3.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_RSA\tmean_entropy\tcor_entropy_RSA\tmean_KL\tintercept\tslope\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_0.6.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_RSA\tmean_entropy\tcor_entropy_RSA\tmean_KL\tintercept\tslope\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_buried_data_ordered_0.6.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_entropy\tmean_KL\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_0.9.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_RSA\tmean_entropy\tcor_entropy_RSA\tmean_KL\tintercept\tslope\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_buried_data_ordered_0.9.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_entropy\tmean_KL\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_data_ordered_1.2.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_RSA\tmean_entropy\tcor_entropy_RSA\tmean_KL\tintercept\tslope\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
...
#open file name
length_counter = 0
designed_mean_graphing_filename = "graph_mean_buried_data_ordered_1.2.csv"
designed_mean_file = open(designed_mean_graphing_filename, "w")
designed_mean_file.write("PDB\tchain\tmean_entropy\tmean_KL\n")
designed_name_length = len(pdb_names)
while(length_counter<designed_name_length):
    ...
    designed_filestring = pdb_names[length_counter] + "\t" + chain_names[length_counter] + "\t" + str(designed_mean_entropy)+ "\t" + str(designed_mean_KL) + "\t" + str(intercept_dict_12[pdb_counter]) + "\t" + str(slope_dict_12[pdb_counter]) +"\n"
    designed_mean_file.write(designed_filestring)
    length_counter = length_counter + 1
designed_mean_file.close()


mean_KL_temp_file = open("graph_mean_KL_all_temp_data_ordered.csv", "w")
...
mean_KL_temp_file = open("graph_mean_KL_buried_temp_data_ordered.csv", "w")
mean_KL_temp_file.write("PDB\tmean_KL_temp_0.0\tmean_KL_temp_0.03\tmean_KL_temp_0.1\tmean_KL_temp_0.3\tmean_KL_temp_0.6\tmean_KL_temp_0.9\tmean_KL_temp_1.2\tmean_KL_split_natural\n")
length_counter = 0
while(length_counter<designed_name_length):
...
mean_KL_temp_file = open("graph_mean_KL_intermediate_temp_data_ordered.csv", "w")
mean_KL_temp_file.write("PDB\tmean_KL_temp_0.0\tmean_KL_temp_0.03\tmean_KL_temp_0.1\tmean_KL_temp_0.3\tmean_KL_temp_0.6\tmean_KL_temp_0.9\tmean_KL_temp_1.2\tmean_KL_split_natural\n")
length_counter = 0
while(length_counter<designed_name_length):
...
mean_KL_temp_file = open("graph_mean_KL_surface_temp_data_ordered.csv", "w")
mean_KL_temp_file.write("PDB\tmean_KL_temp_0.0\tmean_KL_temp_0.03\tmean_KL_temp_0.1\tmean_KL_temp_0.3\tmean_KL_temp_0.6\tmean_KL_temp_0.9\tmean_KL_temp_1.2\tmean_KL_split_natural\n")
length_counter = 0
while(length_counter<designed_name_length):
