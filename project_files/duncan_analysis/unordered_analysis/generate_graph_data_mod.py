...
for path, names, filename in os.walk('.',False): #Searchs for all the *.dat files for the #natural protein 
    for file in filename:
        if(re.search(searchStr, file)!=None):
            ...
            natural_distribution = analysis_functions.get_AA_distribution_mod(natural_proteins)     
            ...
            designed_distribution_00 = analysis_functions.get_AA_distribution_mod(designed_proteins_00)        
            ...
            designed_distribution_01 = analysis_functions.get_AA_distribution_mod(designed_proteins_01)
            ...
            designed_distribution_03 = analysis_functions.get_AA_distribution_mod(designed_proteins_03)
            ...
            designed_distribution_06 = analysis_functions.get_AA_distribution_mod(designed_proteins_06)
            ...
            designed_distribution_09 = analysis_functions.get_AA_distribution_mod(designed_proteins_09)
            ...
            designed_distribution_12 = analysis_functions.get_AA_distribution_mod(designed_proteins_12)
            ...
            designed_distribution_003 = analysis_functions.get_AA_distribution_mod(designed_proteins_003)
