...
\bibitem[{Bastolla et~al.(2005)Bastolla, Porto, Roman, and
  Vendruscolo}]{Bastolla2005}
...
\bibitem[{Bloom et~al.(2006)Bloom, Labthavikul, Otey, and
  Arnold}]{Bloometal2006}
...
\bibitem[{Bustamante et~al.(2000)Bustamante, Townsend, and
  Hartl}]{Bustamante2000}
...
\bibitem[{Chothia and Finkelstein(1990)}]{ChothiaFinkelstein1990}
...
\bibitem[{Conant and Stadler(2009)}]{Conant2009}
...
\bibitem[{Drummond and Wilke(2008)}]{Drummond2008}
...
\bibitem[{Elcock(2001)}]{Elcock2001}
...
\bibitem[{Franzosa and Xia(2009)}]{Franzosa2009}
...
\bibitem[{Fraser et~al.(2002)Fraser, Hirsh, Steinmetz, Scharfe, and
  Feldman}]{Fraser2002}
...
\bibitem[{Friedland et~al.(2009)Friedland, Lakomek, Griesinger, Meiler, and
  Kortemme}]{Friedland2009}
...
\bibitem[{Gainza et~al.(2012)Gainza, Roberts, and Donald}]{Ganinza2012}
...
\bibitem[{Goldman et~al.(1998)Goldman, Thorne, and Jones}]{Goldman1998}
...
\bibitem[{Kuhlman and Baker(2000)}]{Kuhlman2000}
...
\bibitem[{Lazaridis and Karplus(1999)}]{Lazaridis1999}
...
\newblock {ROSETTA3:} an object-oriented software suite for the simulation and
  design of macromolecules.
\newblock \emph{Methods in Enzymology} \textbf{487}:545--574.

\bibitem[{Levy et~al.(2012)Levy, De, and Teichmann}]{Levyetal2012}
...
\bibitem[{Meyer and Wilke(2012)}]{MeyerWilke2012}
...
\bibitem[{Moelbert et~al.(2004)Moelbert, Emberly, and Tang}]{Moelbertetal2004}
...
\bibitem[{Ollikainen and Kortemme(2013)}]{OllikainenKortemme}
...
\bibitem[{Punta et~al.(2012)Punta, Coggill, Eberhardt, Mistry, Tate, Boursnell,
  Pang, Forslund, Ceric, Clements, Heger, Holm, Sonnhammer, Eddy, Bateman, and
  Finn}]{Pfam}
...
\bibitem[{Ramsey et~al.(2011)Ramsey, Scherrer, Zhou, and Wilke}]{Ramsey2011}
...
\bibitem[{Smith and Kortemme(2010)}]{Smith2010}
...
\bibitem[{Tartaglia et~al.(2007)Tartaglia, Pechmann, Dobson, and
  Vendruscolo}]{Tartagliaetal2007}
...
\bibitem[{Tien et~al.(2013)Tien, Meyer, Sydykova, Spielman, and Wilke}]{Tien}
...
\bibitem[{Yona and Levitt(2002)}]{Yona2002}
...
\bibitem[{Zarrinpar et~al.(2003)Zarrinpar, Park, and Lim}]{Zarrinpar2003}
